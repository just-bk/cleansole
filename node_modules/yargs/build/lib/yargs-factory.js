...
export class YargsInstance {
  ...
  demand(keys, max, msg) {
    ...
    } else
    {
      ...
      if (msg === true || typeof msg === 'undefined') {
  ...
  env(prefix) {
    ...
    if (prefix === false)
    delete __classPrivateFieldGet(this, _YargsInstance_options, "f").envPrefix;else
  ...
  [kRunYargsParserAndExecuteCommands](args, shortCircuit, calledFromCommand, commandIndex = 0, helpOnly = false) {
    ...
    Object.keys(argv).forEach((key) => {
      ...
      if (key === __classPrivateFieldGet(this, _YargsInstance_versionOpt, "f") && argv[key]) {
        versionOptSet = true;
      }
    });
    argv.$0 = this.$0;
    ...
    try {
      ...
      __classPrivateFieldGet(this, _YargsInstance_usage, "f").fail(err.message, err);else
  ...
  [kRunValidation](aliases, positionalMap, parseErrors, isDefaultCommand) {
    ...
    return (argv) => {
      ...
      if (__classPrivateFieldGet(this, _YargsInstance_strictOptions, "f")) {
